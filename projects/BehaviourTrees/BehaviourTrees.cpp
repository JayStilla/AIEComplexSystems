...
bool BehaviourTrees::onCreate(int a_argc, char* a_argv[]) 
{
	...
	Behaviour* seek = new SeekTarget(20); 
...
void BehaviourTrees::onUpdate(float a_deltaTime) 
{
	...
	Gizmos::addAABBFilled(m_agent->getTarget(), glm::vec3(0.1f), glm::vec4(1, 0, 0, 1));
	//Gizmos::addAABBFilled(m_agent->getTarget2(), glm::vec3(0.1f), glm::vec4(1, 0, 0, 1));
...
int main(int argc, char* argv[])
{
	...
	if (app->create("AIE - BehaviourTrees",DEFAULT_SCREENWIDTH,DEFAULT_SCREENHEIGHT,argc,argv) == true)
		app->run();
